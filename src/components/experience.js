        ...
        <div className="project">
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold mb-2">
              Software Engineer - Specializing in Ruby on Rails, Mobile and Web
            ...
            <p className="mb-4">
              ...
              <ul className="list-disc pl-5 mt-2">
                <li>
                  Application Contribution: Assisted in refining LoadUp's
                  primary applications, supporting the interaction between
                  loaders and customers in the junk removal process.
                </li>
                <li>
                ...
                <li>
                  ...
                  on Rails, contributing to application stability and
                  performance.
                </li>
                <li>
                  Frontend Collaboration: Worked with the team using Tailwind
                  CSS to achieve responsive and intuitive UI/UX designs.
                </li>
                <li>
                ...
                <li>
                  ...
                  environment, working alongside cross-functional teams to
            ...
            <p className="mb-4">
              Leadership · Problem Solving · Adaptation · Back-End Web
              Development · Software Development · Application Programming
              Interfaces (API) · GitHub · Mobile Applications · GatsbyJS ·
              Tailwind CSS · GraphQL · Cascading Style Sheets (CSS) · Git ·
              Programming · Ruby on Rails · React.js · Node.js · PostgreSQL ·
              Rails · Ruby
            </p>
          </div>
        </div>
